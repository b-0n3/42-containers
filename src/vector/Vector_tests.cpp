...
void iterator_tests(void)
{
    ...
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " == operator iterator and const iterator"
              << "] --------------------]\t\t\033[0m";
    {
        ft::vector<int>::const_iterator  ft_c_ob(my_it);
        std::vector<int>::const_iterator c_ob(it);
        EQUAL((c_ob == it) == (ft_c_ob == my_it));
    }
    std::cout << "\033[1;37m[-------------------- [" << std::setw(40) << std::left << " != operator "
              << "] --------------------]\t\t\033[0m";
    EQUAL((it != it1) == (my_it != my_it1));
